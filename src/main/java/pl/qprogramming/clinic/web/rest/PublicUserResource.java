...
public class PublicUserResource {
    ...
    public PublicUserResource(AccountService accountService) {
    ...
    public ResponseEntity<List<UserDTO>> getAllPublicUsers(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
        ...
        final Page<UserDTO> page = accountService.getAllPublicUsers(pageable);
    ...
    public List<String> getAuthorities() {
        return accountService.getAuthorities();
    }
}
